...
class _settingAccState extends State<settingAcc> {
  ...
  Widget build(BuildContext context) {
    ...
    final text = GoogleFonts.ubuntu(
        ...
        color:
        HexColor(context.watch<brightessSwitch>().text).withOpacity(1));
    ...
    final checkerInvisible = GoogleFonts.ubuntu(
        color:
        HexColor(context.watch<brightessSwitch>().text).withOpacity(0));
        ...
        SliverList(
          delegate: SliverChildListDelegate(
              ...
              Padding(
                ...
                child: Text('Email: $email',style: GoogleFonts.ubuntu(fontWeight: FontWeight.bold,fontSize: 21),),
              ),
               Padding(
                 padding: const EdgeInsets.symmetric(horizontal: 15.0),
                   child: ElevatedButton(
                      style: ButtonStyle(
                       ...
                       child: Text('Reset password',style: text,)
                   ),
                 ),
                 Center(child: Text('email sended check your poste',style: resetSended ? checkerVisible : checkerInvisible)),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15.0),
                    child: ElevatedButton(
                        style: ButtonStyle(
                        ...
                        child: Text('Verify email',style: text,)

                    ),
                  ),
                Center(child: Text(result.toString(),style: verifySended ? checkerVisible : checkerInvisible)),
